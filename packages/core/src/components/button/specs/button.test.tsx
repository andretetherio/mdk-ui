...
describe('button', () => {
  ...
  it('applies variant classes correctly', () => {
    ...
    expect(container.firstChild).toHaveClass('mining-sdk-button--variant-outline')

    rerender(<Button variant="ghost">Ghost</Button>)
    expect(container.firstChild).toHaveClass('mining-sdk-button--variant-ghost')
  })
  ...
  it('applies size classes correctly', () => {
    ...
    expect(container.firstChild).toHaveClass('mining-sdk-button--size-sm')

    rerender(<Button size="md">Medium</Button>)
    expect(container.firstChild).toHaveClass('mining-sdk-button--size-md')

    rerender(<Button size="lg">Large</Button>)
    expect(container.firstChild).toHaveClass('mining-sdk-button--size-lg')
  })
  ...
  it('applies fullWidth class when prop is true', () => {
    ...
    expect(container.firstChild).toHaveClass('mining-sdk-button--full-width')
  })
  ...
  it('shows loading spinner when loading is true', () => {
    ...
    expect(container.querySelector('.mining-sdk-button__spinner')).toBeInTheDocument()
  ...
  it('renders icon on the left by default', () => {
    ...
    const icons = container.querySelectorAll('.mining-sdk-button__icon')
    expect(icons).toHaveLength(1)
    const button = container.firstChild as Element | null
    expect(button?.firstElementChild?.className).toContain('mining-sdk-button__icon')
  })
  ...
  it('renders icon on the right when iconPosition is right', () => {
    ...
    expect(icons).toHaveLength(1)
    const button = container.firstChild as Element | null
    expect(button?.lastElementChild?.className).toContain('mining-sdk-button__icon')
  })

  it('applies icon-only class when icon without children', () => {
    const { container } = render(<Button icon={<span>👍</span>} />)
    expect(container.firstChild).toHaveClass('mining-sdk-button--icon-only')
  })

  it('wraps children in label span', () => {
    const { container } = render(<Button>Click me</Button>)
    expect(container.querySelector('.mining-sdk-button__label')).toBeInTheDocument()
  })
  ...
  it('applies custom className', () => {
    ...
    expect(container.firstChild).toHaveClass('mining-sdk-button')
  })

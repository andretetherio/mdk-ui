...
describe('incidentSeverity', () => {
  it('should render with critical severity', () => {
    ...
    const element = container.querySelector('.mining-sdk-active-incidents-card__dot')
    expect(element).toBeInTheDocument()
    expect(element).toHaveClass('mining-sdk-active-incidents-card__dot--critical')
  })
  ...
  it('should render with high severity', () => {
    ...
    const element = container.querySelector('.mining-sdk-active-incidents-card__dot')
    expect(element).toBeInTheDocument()
    expect(element).toHaveClass('mining-sdk-active-incidents-card__dot--high')
  })
  ...
  it('should render with medium severity', () => {
    ...
    const element = container.querySelector('.mining-sdk-active-incidents-card__dot')
    expect(element).toBeInTheDocument()
    expect(element).toHaveClass('mining-sdk-active-incidents-card__dot--medium')
  })

  it('should always have base class', () => {
    const { container } = render(<IncidentSeverity severity="critical" />)
    const element = container.querySelector('.mining-sdk-active-incidents-card__dot')
    expect(element).toHaveClass('mining-sdk-active-incidents-card__dot')
  })
})

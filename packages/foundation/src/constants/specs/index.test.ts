...
describe('main constants', () => {
  describe('webapp names', () => {
    it('should have webapp name constants', () => {
      ...
      expect(WEBAPP_NAME).toBe('MiningOS')
      expect(WEBAPP_SHORT_NAME).toBe('MOS')
      expect(WEBAPP_DISPLAY_NAME).toBe('Mining OS')
    })

    it('should have consistent naming', () => {
      expect(WEBAPP_SHORT_NAME).toBe('MOS')
      expect(WEBAPP_NAME).toContain('Mining')
      expect(WEBAPP_DISPLAY_NAME).toContain('Mining')
    })
  })

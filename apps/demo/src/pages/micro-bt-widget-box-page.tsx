import { MicroBTWidgetBox } from '@tetherto/mdk-foundation-ui'
...
export const MicroBTWidgetBoxPage = (): JSX.Element => (
  <section className="demo-section">
    ...
    <p className="demo-section__description">
      ...
      <code>cooling_fan_control</code>: running vs error when false or missing). Labels match mdk
      (including &quot;Cicle Pump&quot;).
    </p>
    <div
      style={{
        display: 'grid',
